...
vector <double> Data::GetWallProperties(string wallName)
{
    ...
    wallproperties.push_back(X_min*100);
    wallproperties.push_back(X_max*100);

    wallproperties.push_back(Ny);
    wallproperties.push_back(Y_min*100);
    wallproperties.push_back(Y_max*100);

    wallproperties.push_back(Nz);
    wallproperties.push_back(Z_min*100);
