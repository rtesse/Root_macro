...
/*
  ...
  */
    ...
    TTreeReaderValue<vector<Float_t>> element_E(reader, element_name+".preStepKineticEnergy");
    ...
    while (reader.Next())
    {
        ...
        vector<Float_t> data_elementz = *element_z;
        ...
        for (unsigned int i =0; i < size; i++)
        {
          ...
          ntuple->Fill(xpos,ypos,zpos,energy,xp,yp,zp,partID);
        }
